...
public class FavBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_bactivity);
        setupFavoriteListView();
    }
    private void setupFavoriteListView(){
        ListView listFavorites = (ListView) findViewById(R.id.list_favorites_brazo);
        try{
            SQLiteOpenHelper sfDataBaseHelper = new SFDataBaseHelper(this);
            db = sfDataBaseHelper.getReadableDatabase();
            favoriteCursor = db.query("BRAZO",
                    new String[]{"_id", "NAME"},
                    "FAVORITE = 1",
                    null,null,null,null);
            CursorAdapter favoriteAdapter =
                    new SimpleCursorAdapter(FavBActivity.this,
        ...
        listFavorites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View v, int position, long id) {
                Intent intent = new Intent(FavBActivity.this, BrazoActivity.class);
                intent.putExtra(BrazoActivity.EXTRA_BRAZOID, (int)id);
    ...
    public void onRestart(){
        super.onRestart();
        Cursor newCursor = db.query("BRAZO",
                new String[]{"_id", "NAME"},
                "FAVORITE = 1",
                null,null,null,null);
        ListView listFavorites = (ListView) findViewById(R.id.list_favorites_brazo);
