...
public class FavActivity extends Activity {
    ...
    private void setupFavoriteListView(){
        ...
        try{
            ...
            favoriteCursor = db.query("PECHO",
                    new String[]{"_id", "NAME"},
                    "FAVORITE = 1",
                    null,null,null,null);
            CursorAdapter favoriteAdapter =
                    new SimpleCursorAdapter(FavActivity.this,
        ...
        listFavorites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View v, int position, long id) {
                Intent intent = new Intent(FavActivity.this, PechoActivity.class);
                intent.putExtra(PechoActivity.EXTRA_PECHOID, (int)id);
    ...
    public void onRestart(){
        super.onRestart();
        Cursor newCursor = db.query("PECHO",
                new String[]{"_id", "NAME"},
                "FAVORITE = 1",
                null,null,null,null);
        ListView listFavorites = (ListView) findViewById(R.id.list_favorites);
