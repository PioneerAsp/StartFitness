...
public class BrazoCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brazo_category);
        ...
        try{
            ...
            SimpleCursorAdapter listAdapter = new SimpleCursorAdapter(this,
                    ...
                    0);
            listOptionBrazo.setAdapter(listAdapter);
        ...
        AdapterView.OnItemClickListener itemClickListener =
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> listOptionBrazo, View v, int position, long id) {
                        /**Pasamos el ejercicio seleccionado por el usuario a la siguietne clase que despliega su información*/
                        Intent intent = new Intent(BrazoCategoryActivity.this, BrazoActivity.class);
                        intent.putExtra(BrazoActivity.EXTRA_BRAZOID, (int)id); /*Pasa el Número de ID de la posición seleccionado y lo manda en un mesnaje (Intent)*/
                        startActivity(intent);
                    }
                };
        listOptionBrazo.setOnItemClickListener(itemClickListener);
    }
