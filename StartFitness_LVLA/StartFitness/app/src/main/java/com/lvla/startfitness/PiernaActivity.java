...
public class PiernaActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_PIERNAID = "piernaId";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int piernaId = (Integer)getIntent().getExtras().get(EXTRA_PIERNAID);
        ...
        try{
            ...
            Cursor cursor = db.query("PIERNA",
                    new String[]{"NAME", "DESCRIPTION", "IMAGE_RESOURCE_ID", "FAVORITE"},
                    "_id= ?",
                    new String[] {Integer.toString(piernaId)},
                    null, null, null);
            if(cursor.moveToFirst()){
                ...
                /*Ejercicio Favorito ¿?*/
                CheckBox favorite  = (CheckBox) findViewById(R.id.favoritePierna);
    ...
    public void onFavoriteClicked(View view){
        ...
        piernaValues.put("FAVORITE", favorite.isChecked());
